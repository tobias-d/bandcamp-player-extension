...
const replacements = [
  ...
  {
    name: 'globalThis_fallback_no_dynamic',
    re: /if\(typeof globalThis==="object"\)\{return globalThis\}try\{return this\|\|new Function\("return this"\)\(\)\}catch\(e\)\{if\(typeof window==="object"\)\{return window\}\}/,
    to: 'if(typeof globalThis==="object"){return globalThis}if(typeof self==="object"){return self}if(typeof window==="object"){return window}if(typeof global==="object"){return global}try{return this}catch(e){}',
  },
];
